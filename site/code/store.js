...
const storeEl = store.map(({id, productImage, productName, productDescription, productPrice, currencyUnits}) => {
    return `
    <div class="storeCard">
        <div class="img_box">
        ...
        <div class="store_Card_price">${productPrice}<span>${currencyUnits}</span>
            <div class="btns_block">
                ...
                <button id="${id}" class="btn_add_toCart"><img src="../img/store/ico/shopping-cart-add_ico.svg" alt="shopping-cart-add"></button>
            </div>
        </div>
    </div>
    `
...
class Cart {
    ...
    showNotification(message, duration){
        ...
        const imgCartUrl = "../img/store/ico/cart.png";
  ...
  allBtns_btnAddToCart.forEach(el => {
    el.addEventListener("click", function () {
      const objFromId = store.find(obj => obj.id === el.id);
  ...
  if (cart.prodInCart.length == 0) {
    ...
    modalContent.insertAdjacentHTML("beforeend", `
      <div class="modal__content_container_cart_zero">
        <div class="modal_img">
          <img src="../img/store/ico/empty-shopping-basket.png" alt="empty-shopping-basket">
        </div>
        <div class="title">
          ...
          <div class="modal__card">
                ...
                <div class="modal__prod_price">${productPrice}<span>${currencyUnits}</span>
                  ...
                  <div class="modal__btns_block">
                      ...
                      <button id="${id}" class="btn_delete_prod_from_cart__modal"><img src="../img/store/ico/bin.png" alt="bin"></button>
                  </div>
                </div>
            </div>
        </div>
